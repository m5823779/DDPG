...
class train_world3(gazebo_env.GazeboEnv):
    def __init__(self):
    ...
    def _step(self, action_linear, action_angular):
        ...
        vel_cmd = Twist()
        vel_cmd.linear.x = 0.5 * action_linear
        vel_cmd.angular.z = action_angular
    ...
    def _reset(self):
        ...
        try:
            ...
            self.init_pose.position.x = random.uniform(-3.4, 3.4)
            self.init_pose.position.y = random.uniform(-3.4, 3.4)
